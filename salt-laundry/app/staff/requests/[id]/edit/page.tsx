...
export default function StaffEditRequestPage() {
  ...
  const { draft, flagReason, carriedPrices, isLoading, error } =
    useStaffEditableRequest(id);
        ...
        <>
          <div className="mt-4 mb-6">
            ...
            <p className="text-sm text-salt-text-sec mt-1 max-w-xl">
              Items already on this request keep the price the guest was quoted,
              even if the catalogue has changed since. Only items you add are
              priced from today&apos;s catalogue.
            </p>
          </div>
