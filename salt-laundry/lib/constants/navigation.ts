...
export const PROFILE_NAV_LINK: NavLinkItem = {
  href: "/staff/profile",
  label: "Profile",
};

// Way back out of the dashboard to the public guest request form.
export const HOME_NAV_LINK: NavLinkItem = {
  href: "/",
  label: "Guest form",
  exact: true,
};
...
export const MANAGE_NAV_LINKS: NavLinkItem[] = [
  {
    href: "/staff/items",
    label: "Catalogue",
    permission: "LAUNDRY_REQUEST_ITEMS_CATALOGUE_VIEW",
  },
  {
    href: "/staff/users",
    label: "Users",
    permission: "LAUNDRY_HOUSEKEEPERS_VIEW",
  },
  {
    href: "/staff/reports",
    label: "Reports",
    permission: "LAUNDRY_REPORTS_VIEW",
  },
];
