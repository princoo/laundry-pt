...
export async function assignRequest(requestId: string, housekeeperId: string): Promise<void> {
  ...
  const wasTakenFromSomeoneElse = previousAssigneeId && previousAssigneeId !== housekeeperId
