...
const OPTIONS = [
  {
    ...
    description: 'Returned on a hanger, ready to wear — best for shirts, dresses and suits.',
  },
  {
    isHanger: false,
    label: 'Folded',
          ...
          {OPTIONS.map((option) => {
            ...
            return (
              ...
              >
                ...
                />
                <span>
                  <span className="block text-sm font-medium text-salt-text">{option.label}</span>
