...
export function UserFlagToggle({ checked, onChange, onLabel, offLabel, offColorClass }: Props) {
  return (
    <div className="flex items-center gap-2">
      <PermissionGate permission="LAUNDRY_HOUSEKEEPERS_SHIFTS_MANAGE">
        <ActiveToggle checked={checked} onChange={onChange} offColorClass={offColorClass} />
      </PermissionGate>
