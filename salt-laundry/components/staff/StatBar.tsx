    ...
    <div className="grid grid-cols-[repeat(auto-fit,minmax(130px,1fr))] gap-3">
      ...
      {alertCount !== null && (
        <button
          ...
          className={`bg-white rounded-xl border border-[0.5px] shadow-sm p-4 text-center transition-colors ${alertActive ? 'border-red-400' : 'border-salt-border hover:border-salt-navy'}`}
        >
